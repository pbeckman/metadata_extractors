import json
from metadata_util import extract_metadata, extract_topic
...
def test_metadata_extraction(pass_fail=False):
    for f in [
        ...
        display_metadata(f, "test/test_files/", pass_fail=pass_fail)
        raw_input()

test_metadata_extraction(pass_fail=False)

# with open("test/test_files/readme.txt", "r") as f:
